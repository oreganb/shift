    ...
    <div class="scrollbar" data-simplebar>
        ...
        <div class="sidenav-user text-nowrap border border-dashed rounded-3">
            <a href="#!" class="sidenav-user-name d-flex align-items-center">
                <img src="assets/images/users/user-2.jpg" width="36" class="rounded-circle me-2 d-flex"
                     alt="user-image">
                <span>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="ton-ai.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="directory.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarPagesAuth">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="404.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="charts.php" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarForms">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="form-plugins.php" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="form-quill-editor.php" class="side-nav-link">
